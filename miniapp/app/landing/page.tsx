...
const WHATSAPP_LINK = `https://wa.me/${CALL.replace(/\D/g, "")}?text=${encodeURIComponent("Hi LongiMed — I'd like to ask about a consultation.")}`;
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden lm-landing">
      ...
      <a
        ...
        className="fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-[60] flex items-center justify-center w-14 h-14 sm:w-[60px] sm:h-[60px] rounded-full text-white transition-transform active:scale-95"
        style={{
          background: '#25D366',
          boxShadow: '0 8px 24px rgba(37, 211, 102, 0.35), 0 4px 12px rgba(0,0,0,0.12)',
      ...
      >
        ...
        {/* Pulse ring */}
        <span className="absolute inset-0 rounded-full pointer-events-none" style={{ animation: 'ping-slow 2.5s cubic-bezier(0,0,0.2,1) infinite', boxShadow: '0 0 0 0 rgba(37, 211, 102, 0.4)' }} />
      </a>
      <style jsx>{`
        @keyframes ping-slow {
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-semibold text-[15px] text-white transition-all active:scale-[0.97]"
                      ...
                      <div className="p-5 sm:p-6 flex flex-col flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label={`Book Dr. ${doc.full_name} on Telegram`}
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-full text-[12px] font-semibold text-white active:scale-[0.97] transition-transform"
                            style={{ background: 'var(--navy)' }}
                          >
                          ...
                          <a
                            href={`https://wa.me/${CALL.replace(/\D/g, "")}?text=${encodeURIComponent(`Hi LongiMed — I'd like to book Dr. ${doc.full_name}.`)}`}
                            target="_blank"
                            rel="noopener noreferrer"
