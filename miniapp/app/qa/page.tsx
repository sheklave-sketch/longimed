  ...
  return (
    <div className="pt-5 pb-24">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-6">
        ...
        <p className="text-ink-secondary text-[14px]">Public medical questions answered by verified doctors</p>
      </motion.div>
      ...
      {loading ? (
              ...
              >
                <Link href={`/qa/${q.id}`}>
                  <div className="card card-interactive p-4 group">
                    ...
                    <p className="text-ink-rich text-[14px] font-medium leading-snug line-clamp-2 mb-2 group-hover:text-brand-teal transition-colors">
                      {q.text}
                    </p>

                    {q.answer_text && (
                      <p className="text-ink-secondary text-[13px] leading-relaxed line-clamp-2 bg-surface-muted rounded-xl px-3 py-2">
                        <span className="text-brand-teal font-semibold">Dr: </span>
                        {q.answer_text}
                      </p>
                    )}
        ...
        <EmptyState
          ...
          subtitle="Be the first to ask a medical question"
        />
      )}
